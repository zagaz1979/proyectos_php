<?php
    ...
    /*
    2. En una fábrica de computadores se planea ofrecer a los clientes un descuento 
       ...
       le otorga un 20% de descuento, si son 10 o más se les da un 40% de descuento. 
